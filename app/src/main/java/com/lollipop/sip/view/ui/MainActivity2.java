...
public class MainActivity2 extends AppCompatActivity implements
    ...
    private DataStoreViewModel _viewModelDataStore;
    ...
    private void initializeViewModel() {
        _viewModelDataStore = new ViewModelProvider(this).get(DataStoreViewModel.class);
        _viewModel = new ViewModelProvider(this).get(MainViewModel.class);
    }

    private void observableData() {
        _viewModelDataStore.getUserData().observe(this, result ->{
            _viewModel.showBangunan("show_bangunan",result.get(0));
        });

        _viewModel.getBangunan().observe(this, result -> {
//            result.
        });
    }
    ...
    private static class MainActivityLocationCallback
        ...
        MainActivityLocationCallback(MainActivity2 activity) {
